  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    >
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-8  md:w-1/3">
          <div className="relative w-48 h-48 mx-auto">
            <div className="z-40">
              <img
                src="../../public/lince.jpg"
                alt="lince"
                className="absolute top-0 -left-20 z-10 rounded-lg w-3/4 h-full object-cover "
              />
            </div>
            <div className="z-30">
              <img
                ...
                alt="placa"
                className="absolute top-6 left-6 z-30 rounded-lg w-3/4 h-full object-cover border-4 border-white dark:border-gray-800"
              />
            </div>
            <div className="z-20">
              <img
                ...
                alt="piscina"
                className="absolute top-0 left-32 z-10 rounded-lg w-3/4 h-full object-cover "
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-8  md:w-2/3 text-gray-600 dark:text-gray-300">
